            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/index.php/Admin/Article/newsadd"><i class="icon-font"></i>新增作品</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	                            ...
	                            <td>
	                                <a class="link-update" href="/index.php/Admin/Article/newsedit/id/<?php echo ($vo["id"]); ?>">修改</a>
	                                <a class="link-del"   href="javascript:void(0)" onclick="myfun(this)" id="<?php echo ($vo["id"]); ?>" >删除</a>
	                            </td>
...
<script>
	...
	function myfun(obj){
		if(confirm("确定要删除新闻么？删除后无法恢复！")){		
			var	url ="/index.php/Admin/Article/newsdel/id/"+ obj.id;
