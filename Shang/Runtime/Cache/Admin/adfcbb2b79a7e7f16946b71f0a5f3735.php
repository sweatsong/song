            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                      <a href="<?php echo U('UserInfo/xls');?>"><i class="icon-font"></i>导出表格</a>
                     ...
                     <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="58" type="checkbox"></td>
                     		 ...
                     		 <td style="text-align:center"><?php echo ($vo["username"]); ?></td>
                                        <td style="text-align:center"><?php echo ($vo["telephone"]); ?></td>
                                        <td style="text-align:center"><?php echo ($vo["province"]); ?></td>
                                        <td style="text-align:center"><?php echo ($vo["city"]); ?></td>
