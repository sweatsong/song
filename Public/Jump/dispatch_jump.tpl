...
<html class="bg4">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="__JUMP__/css/style.css" />
	...
	<body>
		...
		<!--JS FILES LOAD-->
		<script src="__JUMP__/script/jquery.min.js" type="text/javascript"></script>
		<script src="__JUMP__/script/jcountdown.min.js" type="text/javascript"></script>
		<script src="__JUMP__/script/main.js" type="text/javascript"></script>
